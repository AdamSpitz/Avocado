...
thisModule.addSlots(avocado.TableMorph.prototype, function(add) {
  ...
  add.data('padding', {left: 10, right: 10, top: 10, bottom: 10, between: {x: 10, y: 10}}, {initializeTo: '{left: 10, right: 10, top: 10, bottom: 10, between: {x: 10, y: 10}}', category: ['layout']});
...
thisModule.addSlots(avocado.VerticalDirection, function(add) {
  ...
  add.data('toString', function() { return 'vertical'; });
...
thisModule.addSlots(avocado.HorizontalDirection, function(add) {
  ...
  add.data('toString', function() { return 'horizontal'; });
